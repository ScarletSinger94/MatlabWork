...
% initialize figure
hFig = figure('Menubar','none', 'Color','cy');
...
hidden off;    % hidden surface removal
...
% text
props = {'FontWeight','bold','FontSize',100};
pause(.2)
...
pause(.2)
 ...
 text('Position',[51 47 28],'FontName','Bookman','FontSize',32,...
